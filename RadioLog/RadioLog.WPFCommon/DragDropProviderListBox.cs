...
{
    public class DragDropProviderListBox : ListBox
    {
        public const string DEFAULT_FORMATSTRING = "RadioLogCommonData";

        public DragDropProviderListBox()
            : base()
        {
        ...
        private ListBoxItem _dragListItem = null;
        ...
        protected override void OnPreviewMouseLeftButtonDown(System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            if (d == null)
                return;
            _dragListItem = FindAnchestor<ListBoxItem>(d);
        }
